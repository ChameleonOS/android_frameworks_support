...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintSelected.setColor(res.getColor(android.R.color.holo_blue_light));
        mPaintUnselected.setColor(0xFFBBBBBB);
        mLineWidth = (int) (12 * density);
        mGapWidth = (int) (4 * density);
        setStrokeWidth((int) (2 * density));
        mCentered = true;
    ...
    public void setStrokeCap(Paint.Cap cap) {
        mPaintSelected.setStrokeCap(cap);
        mPaintUnselected.setStrokeCap(cap);
    }

    public Paint.Cap getStrokeCap() {
        return mPaintSelected.getStrokeCap();
    }
